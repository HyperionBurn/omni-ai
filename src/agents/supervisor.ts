    ...
    while (!isDone) {
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          tools: [{ functionDeclarations: [searchWebTool, searchMapsTool, generateImageTool, saveArtifactTool, readUrlTool, calculatorTool, getWeatherTool, getCurrentTimeTool, saveMemoryTool, searchMemoryTool, solveLogicProblemTool, executeTdadTaskTool, semanticDataTool, getBestStrategyTool, rewardStrategyTool, executeCodeTool] }],
